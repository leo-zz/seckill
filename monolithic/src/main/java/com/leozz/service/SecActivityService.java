...
public interface SecActivityService {
    ...
    /**
     *  点击抢购按钮后触发的逻辑，重新检查秒杀活动的状态、库存，以及当前用户是否参与过此活动{@link SecActivityService#beginSecActivity(java.lang.Long, java.lang.Long)}；
     ...
     */
    boolean beginSecActivity(Long secActivityId,Long userId);
